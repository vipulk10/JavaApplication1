 ...
 * @author vipul
 */
public class rnwest extends javax.swing.JFrame {

    /**
     * Creates new form rnwest
     */
    public rnwest() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Udit raj");

        jTextField2.setText("Krishna tirath");

        jTextField3.setText("Rakhi birla");
    ...
    try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from northwest where party=?");
            ps.setString(1,b );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rnwest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
